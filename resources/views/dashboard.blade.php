    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
            <h1 class="text-4xl font-black text-slate-900 tracking-tight leading-tight">
                Store <span class="text-indigo-600">Analytics</span>
            </h1>
            <p class="text-slate-500 mt-2 text-lg font-medium">Insights and operations for <span class="text-slate-900 font-bold tracking-tight">Toko Alpin</span></p>
        </div>
        <div class="flex items-center gap-4">
            ...
            <div class="bg-indigo-50 border border-indigo-100 rounded-2xl px-6 py-3 flex items-center gap-3">
                ...
                <span class="text-indigo-800 font-bold text-sm tracking-wide uppercase">{{ now()->format('l, d M Y') }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="glass-card p-8 group hover:bg-slate-900 transition-all duration-500 border-b-4 border-indigo-500">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-indigo-300">Revenue</span>
            </div>
            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 group-hover:text-slate-500">Total Income</p>
        ...
        <div class="glass-card p-8 group hover:bg-slate-900 transition-all duration-500 border-b-4 border-emerald-500">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-emerald-300">Volume</span>
            </div>
            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 group-hover:text-slate-500">Total Sales</p>
        ...
        <div class="glass-card p-8 group hover:bg-slate-900 transition-all duration-500 border-b-4 border-purple-500">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-purple-300">Catalog</span>
            </div>
            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 group-hover:text-slate-500">Active Items</p>
        ...
        <div class="glass-card p-8 group hover:bg-slate-900 transition-all duration-500 border-b-4 border-amber-500">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-amber-300">Base</span>
            </div>
            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 group-hover:text-slate-500">Customers</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-black text-slate-900 tracking-tight">Recent <span class="text-indigo-600">Transactions</span></h2>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50 border-b border-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-400">
                                <th class="px-8 py-5">Node ID</th>
                                <th class="px-8 py-5">Partner</th>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            @foreach($recentTransactions as $transaction)
                                <tr class="hover:bg-slate-50/50 transition">
                                    ...
                                    <td class="px-8 py-6 font-bold text-slate-800">{{ $transaction->user->name ?? 'Point of Sale' }}</td>
                                    <td class="px-8 py-6 text-right font-black text-slate-900">Rp {{ number_format($transaction->total_price, 0, ',', '.') }}</td>
                                    <td class="px-8 py-6 text-center">
                                        <span class="badge-modern bg-emerald-100 text-emerald-600">Verified</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="space-y-6">
            <h2 class="text-2xl font-black text-slate-900 tracking-tight items-center flex gap-3">
                Action <span class="text-red-500/80">Needed</span>
            ...
            <div class="glass-card p-6 space-y-4 shadow-xl shadow-red-500/5">
                ...
                @empty
                    <div class="text-center py-10">
                        ...
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-widest">Inventory Optimized</p>
                    </div>
                @endforelse
            </div>
        </div>
