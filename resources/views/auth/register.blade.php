    ...
    <div class="w-full max-w-lg">
        <div class="glass-card p-12 border border-white shadow-2xl shadow-slate-200/50 bg-white/70 backdrop-blur-2xl rounded-[40px] space-y-10">
            <div class="text-center space-y-4">
                ...
                <div>
                    <h1 class="text-3xl font-black text-slate-900 tracking-tighter">Node <span class="text-indigo-600">Generation</span></h1>
                    <p class="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-500 mt-2">Protocol: Gmail Exclusive Enrollment</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-8">
                ...
                <div class="space-y-3">
                    <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1">Entity Name</label>
                ...
                <div class="space-y-3">
                    <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1">Gmail Backbone</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1">Access Key</label>
                        <input type="password" name="password" required 
                               class="input-modern !py-5 !px-8 !rounded-[24px]" 
                               placeholder="••••••••">
                    </div>
                    <div class="space-y-3">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1">Key Confirmation</label>
            ...
            <div class="pt-8 border-t border-slate-50 text-center">
                <p class="text-sm font-medium text-slate-400">
                    Key already exists? 
                    <a href="{{ route('login') }}" class="text-indigo-600 font-black hover:text-indigo-800 transition-colors ml-1">Authenticate Node</a>
                </p>
            </div>
        </div>
    </div>
