    ...
    <div class="w-full max-w-lg">
        <div class="glass-card p-12 border border-white shadow-2xl shadow-slate-200/50 bg-white/70 backdrop-blur-2xl rounded-[40px] space-y-10">
            <div class="text-center space-y-4">
                ...
                <div>
                    <h1 class="text-3xl font-black text-slate-900 tracking-tighter">Identity <span class="text-indigo-600">Verification</span></h1>
                    <p class="text-slate-500 mt-2 font-medium">Access your enterprise terminal node</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-8">
                @csrf
                <div class="space-y-3">
                    <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] pl-1">Email Protocol</label>
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center pl-1">
                        ...
                        <a href="{{ route('password.request') }}" class="text-[10px] font-black text-indigo-500 uppercase tracking-widest hover:text-indigo-700 transition-colors">Encryption Reset</a>
                    </div>
                ...
                <div class="flex items-center justify-between px-1">
                    <label class="flex items-center cursor-pointer group">
                        ...
                        <span class="ml-3 text-xs font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Persistent Session</span>
                    </label>
                </div>
            ...
            <div class="pt-8 border-t border-slate-50 text-center">
                <p class="text-sm font-medium text-slate-400">
                    Unauthorized access? 
                    <a href="{{ route('register') }}" class="text-indigo-600 font-black hover:text-indigo-800 transition-colors ml-1">Generate Node Identity</a>
                </p>
            </div>
        </div>
    </div>
